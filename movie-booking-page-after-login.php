...
{ 
  if($password1==$row['password'])
  {
   ...
   header('location:http://localhost/moviebookingwebsite/movie-booking-page.php');
  }
  else
  {
?>
   ...
   <body>
     <div class="login">
        <form class="log-in-form" action="movie-booking-page-after-login.php" method="post">
...
{?>
  <html>
   ...
   <body>
     <div class="login">
        <form class="log-in-form" action="movie-booking-page-after-login.php" method="post">
         <div><input type="test" name="phoneno" placeholder="Mobile Number/Email Id"/><div style="color:white;">User Id does not exist!</div></div>
