  ...
  {?>
    ...
    {?>
      <div style="width:100%;background-color:#fff;height:300px;padding:50px 60px;">
        <div style="font-family:'Jenna Sue', sans-serif; font-size:46px;padding: 0px 20px;">Sorry,Today seat booking already closed for that time, pls select another date.</div>
      </div>
    <?php
    }
 }
