...
{ 
  if($password1==$row['password'])
  {
   ...
   header('location:http://localhost/moviebookingwebsite/city-wise-cinema-hall.php');
  }
  else
  {
?>
   ...
   <body>
     <div class="login">
        <form class="log-in-form" action="citywise-hall-page-login-validation.php" method="post">
